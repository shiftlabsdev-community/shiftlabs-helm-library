# StatefulSet Helm Chart

Production-ready Helm chart for Kubernetes StatefulSets with persistent storage, modern best practices, security hardening, and comprehensive health checks.
...
- Distributed Systems (Elasticsearch, Redis Cluster, Zookeeper)
- Caching Systems (Redis, Memcached)

## Features

- **Persistent Storage**: Automatic PVC creation with volumeClaimTemplates
- **Stable Network Identity**: Headless service support for stable DNS names
- **Ordered Updates**: RollingUpdate with partition support for canary deployments
